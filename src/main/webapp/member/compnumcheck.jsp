...
<b><font size="4" color="gray">사업자등록번호 중복 확인</font></b>
	<br>
	
	<form name="checkEmailForm">
		
		<%if(check){ %>
			<p style="color: green">사용 할 수 있는 아이디입니다.</p>
		<%}else{ %>
	...
	<script>
        ...
        function setParentText(){
        	opener.document.querySelector("#compnumcheck").value = document.querySelector("#check").value;
        	window.close();
        }
    </script>
